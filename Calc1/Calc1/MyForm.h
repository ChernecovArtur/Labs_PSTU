...
namespace Calc1 {
	...
	#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabPage1->Text = L"Êðåäèòíûé êàëüêóëÿòîð";
			...
			this->button7->Text = L"Äîï. èíôîðìàöèÿ";
			...
			this->label4->Text = L"Åæåìåñÿ÷íûé ïëàòåæ ïî êðåäèòó ñîñòàâèò: ";
			...
			this->button1->Text = L"Ðàñ÷èòàòü ïëàòåæ ïî êðåäèòó";
			...
			this->label3->Text = L"Ñðîê êðåäèòîâàíèÿ, ìåñ";
			...
			this->label2->Text = L"Ïðîöåíòíàÿ ñòàâêà, %";
			...
			this->label1->Text = L"Ñóììà êðåäèòà, òûñ. ðóá";
			...
			this->tabPage2->Text = L"Êàëüêóëÿòîð âêëàäîâ";
			...
			this->button6->Text = L"Äîï. èíôîðìàöèÿ";
			...
			this->label11->Text = L"Ñóììà äåíåæíûõ ñðåäñòâ ïî îêîí÷àíèè ñðîêà âêëàäà, òûñ:";
			...
			this->button4->Text = L"Ðàñ÷èòàòü èòîãîâóþ ñóììó";
			...
			this->label10->Text = L" ×èñëî                   Ìåñÿö                   Ãîä";
			...
			this->label9->Text = L"Äàòà ïîñòóïëåíèÿ âêëàäà:";
			...
			this->label8->Text = L"Êîëè÷åñòâî äíåé íà÷èñëåíèÿ ïðîöåíòîâ, äí:";
			...
			this->label7->Text = L"Ãîäîâàÿ ïðîöåíòíàÿ ñòàâêà, %:";
			...
			this->label6->Text = L"Ïåðâîíà÷àëüíàÿ ñóììà âêëàäà, òûñ. ðóá:";
			...
			this->Text = L"Êàëüêóëÿòîð êðåäèòîâ è âêëàäîâ";
